          ...
          >
            <div className="flex items-center justify-between gap-4 flex-wrap">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-red-200 font-bold text-sm">FREE PLAN - Limited Analysis</p>
                  <p className="text-white/80 text-xs">Basic feedback only</p>
                </div>
              </div>
            ...
            >
              ...
              {(!user?.subscription_tier || user?.subscription_tier === 'free') && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-red-900/30 border-2 border-red-500/50 rounded-xl p-5 mb-6"
                >
                  <div className="flex items-start gap-3">
                    <Lock className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
                    <div className="flex-1">
                      <p className="text-white text-sm mb-3">
                        This is a limited free analysis. Upgrade to unlock advanced analysis, share and download scans.
                      </p>
                      <Link to={createPageUrl('Pricing')}>
                        <Button size="sm" className="bg-red-500 hover:bg-red-400 text-white font-semibold">
                          Upgrade Now
                        </Button>
                      </Link>
                    </div>
