            ...
            >
              ...
              {(user?.subscription_tier === 'free' || !user?.subscription_tier) && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-gradient-to-r from-yellow-900/30 to-orange-900/30 border-2 border-yellow-500/50 rounded-xl p-4 mb-4"
                >
                  <div className="flex items-start gap-3">
                    <Lock className="w-5 h-5 text-yellow-400 flex-shrink-0 mt-0.5" />
                    <div>
                      <h3 className="text-yellow-400 font-semibold mb-1">Limited Free Analysis</h3>
                      <p className="text-white/80 text-sm mb-2">
                        You're viewing a basic scan with limited feedback. Upgrade to Professional or Enterprise for:
                      </p>
                      <ul className="text-white/70 text-xs space-y-1 mb-3">
                        ...
                        <li>• Career trajectory analysis with industry benchmarks</li>
                        <li>• Advanced risk assessment and detailed insights</li>
                      </ul>
                      <Link to={createPageUrl('Pricing')}>
                        <Button size="sm" className="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold">
                          Upgrade Now
                        </Button>
                      </Link>
                    </div>
