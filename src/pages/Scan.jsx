...
Report generated by Indexios Resume Verification Platform
  ...
  return (
    <>
      <Helmet>
        <title>Scan Resume - Indexios</title>
        <meta name="description" content="Upload and analyze resumes with AI-powered fraud detection. Get instant legitimacy scores and detailed verification reports." />
