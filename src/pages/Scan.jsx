            ...
            >
              ...
              {(user?.subscription_tier === 'free' || !isAuthenticated) && (
                <motion.div
                  initial={{ opacity: 0, y: -10 }}
                  animate={{ opacity: 1, y: 0 }}
                  className="bg-gradient-to-r from-purple-900/40 to-indigo-900/40 border-2 border-purple-500/60 rounded-xl p-4 text-center"
                >
                  <p className="text-purple-300 text-sm font-medium">
                    Upgrade to save your scan history and unlock team collaboration features
                  </p>
                  <Link to={createPageUrl('Pricing')}>
