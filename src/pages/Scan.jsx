              ...
              {selectedCandidate.analysis && (
                <>
                  ...
                  <EmploymentConfirmation
                    companies={selectedCandidate.analysis.companies || []}
                    phoneNumbers={selectedCandidate.analysis.company_phone_numbers || {}}
                    allCompanies={selectedCandidate.analysis.company_names || []}
                    phoneDebug={selectedCandidate.analysis.company_phone_debug || {}}
                  />
                  </>
                  )}
                  </motion.div>
